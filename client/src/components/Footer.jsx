...
export default function Footer({ PRODUCT_NAME = "Flux" }) {
	return (
		<footer className="relative mt-auto border-t border-slate-200/80 bg-white/80 backdrop-blur-sm shadow-[0_-1px_2px_rgba(0,0,0,0.02)] font-mono-ui">
			{/* Subtle gradient line above the footer */}
			<div className="absolute -top-px left-0 right-0 h-px bg-gradient-to-r from-transparent via-teal-400/40 to-transparent" />

			<div className="max-w-6xl mx-auto px-6 py-10">
				<div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
					{/* Brand section */}
					<div className="flex items-center gap-3">
						<Logo variant="light" className="w-8 h-8" showText={true} />
					...
					<div className="flex flex-col items-start md:items-end gap-3">
						<div className="flex items-center gap-5 text-xs text-slate-500">
							<span className="text-[11px] font-medium text-slate-400 tracking-wide">
								© {new Date().getFullYear()} Flux Agile. All rights reserved.
							</span>
